          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <!--<h3>PURCHASE AND SALES REPORT</h3>-->
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Purchase and Sales Report</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table class="top-field" id="purchase_repo">
			<tr>
			  <td><input type="checkbox" class="checkbox" style="left: -6px;"></td>
			  <td>From Date</td>
			  <td><input type="text" style="width: 78%;" id="cFrom"></td>
			  <td>To Date</td>
			  <td><input type="text" style="width: 78%;" id="cTo"></td>
			</tr>
			...
			<tr>
			  <td class="resize" style="width: 35%;">Company Name</td>
			...
			<tr>
			  ...
			  <td class="resize"><input type="text"></td>
			   <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn2" class="txt-inputs"></td>
			</tr>
			<tr>
			  <td class="resize">Customer</td>
			  <td class="resize"><input type="text"></td>
			...
			<tr>
			  ...
			  <td class="resize"><input type="text"></td>
			   <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn4" class="txt-inputs"></td>
			</tr>
			<tr>
			  <td class="resize">Vehicle No</td>
			  <td class="resize"><input type="text"></td>
			...
			<tr>
			  ...
			  <td class="resize"><input type="text"></td>
			   <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn7" class="txt-inputs"></td>
			</tr>
		      </table>
		      
		       <table class="top-field" id="top-crusher">
			<tr>
			  <td><input type="checkbox" name="purchase" class="checkbox"></td>
			  <td>Customer</td>
			  <td><input type="checkbox" name="purchase" class="checkbox"></td>
			  <td>Supplier</td>
		      ...
		      <button type="button" style="width: 120px; height: 41px; line-height: 10px;" class="button"><a href="purchase_and_sales_report._print.html">Submit</a></button>
...
<div id="myModal2" class="modal2">
  ...
  <div class="modal-content2">
    <div class="vehicle-search">Vehicle Search</div>
    <div class="in-model">
    
    <span class="close2" style="opacity:7;">&times;</span>
    <table style="width: 96%;margin-top: 14px;">
      <tr>
	<td>Search By Vehicle Number</td>
	<td><input type="text"></td>
      </tr>
      </table>
      <div class="model-grid">
...
window.onclick = function(event) {
 ...
 <div id="myModal6" class="modal6">
  ...
  <div class="modal-content6">
    ...
    <span class="close6" style="opacity:7;">&times;</span>
    <table style="width: 96%;margin-top: 14px;">
      <tr>
