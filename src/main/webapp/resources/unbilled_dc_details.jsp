          ...
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="top-field" id="unfilled_tabs">
			<tr>
			...
			<tr>
			  ...
			  <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn3" class="txt-inputs"></td>
		       ...
		       <table class="top-field" id="unfilled">
			<tr>
		      ...
		      <button type="button" id="unfill_btn" class="button">Submit</button>
