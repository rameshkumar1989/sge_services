        ...
        <div class="right_col" role="main">
          <div class="">
		    ...
		    <div class="supplier-view" id="transport">
		      ...
		      <table style="width: 113%;" class="transport_table">
  ...
  if (code == 13) {
    ...
    $('.inputss').eq(index).focus();
		    ...
		    <div class="whole-payment">
			 ...
			 <fieldset>
  <legend class="transport_legend"><b>Transport Master:</b></legend>
   <table class="sub-table1">
    <tr>
      <td class="text-sub-tra">Transport Code</td>
      <td><input type="text" readonly></td>
       
    </tr>
    
    <tr>
      <td class="text-sub-tra">Vehicle Type</td>
      <td><input type="text"></td>
    ...
    <tr>
      <td class="text-sub-tra">Address 1</td>
      <td><input type="text"></td>
       
    </tr>
    <tr>
      <td class="text-sub-tra">Vehicle Measurement 1</td>
      <td><input type="text"></td>
       
    </tr>
    <tr>
      <td class="text-sub-tra">Vehicle Measurement 2</td>
      <td><input type="text"></td>
