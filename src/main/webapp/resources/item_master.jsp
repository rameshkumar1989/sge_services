...
$("document").ready(function(){
      ...
      $('.addrow').click(function() 
     {
    	...
    	$(".item_table").append('<tr id="remove_table"><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td style="padding:0px; background: #fff;text-align: center;"><img src="images/cancel_tab.png" onclick="deleterow()" style="width:18px;"></td></tr>'); 
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<tr>
			  ...
			  <td style="width: 57%;text-align: end;">Search By Item Code/Name</td>
		    ...
		    <div class="supplier-view-item" id="item">
  ...
  if (code == 13) {
    ...
    $('.inputss').eq(index).focus();
		    ...
		    <div class="whole-payment">
		     ...
		     <div class="supplier-list" style="width: 69%;margin-left: 166px;">
		      
		       
			 <fieldset>
  <legend id="item_legend"><b>Item Master:</b></legend>
   <table class="sub-table1" style="width: 100%;">
    <tr>
      <td class="text-sub1">Item Code</td>
      <td><input type="text"></td>
       <td class="text-sub1">Item Name</td>
      <td><input type="text"></td>
    </tr>
		    ...
		    <div class="right-whole-design-suppliers">
		      <table>
			<tr>
			  <td><button type="button" class="button-suppliers"><img src="images/add.png" style="width: 53%;"></br>Add</button></td>
