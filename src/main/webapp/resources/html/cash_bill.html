...
$("document").ready(function(){
      ...
      $('.addrow').click(function() 
     {
    	...
    	$(".sales_table").append('<tr id="remove_table"><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td style="padding:0px; background: #fff;text-align: center;"><img src="images/cancel_tab.png" onclick="deleterow()" style="width:18px;"></td></tr>'); 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li class="checkdrop"><a><i class="fa fa-home"></i> <span style="z-index: -1;">Home</span> </span></a>
                  <!--  <ul class="nav child_menu">
                      <li><a href="#">Dashboard</a></li>
                       
                    </ul>-->
                  </li>
                  <li class="checkdrop"><a><i class="fa fa-edit"></i> Purchase <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
		      ...
		      <li><a href="crusher_entry.html">Crusher Entry</a></li> 
                  ...
                  <li class="drop"><a><i class="fa fa-desktop"></i> Sales Order <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
...
<div class="form-name">SRI GANAPATHY ENTERPRISES</div>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<tr>
			  <td style="width: 10%; padding-right: 0px;">Sales No</td>
			  <td ><input type="text" id="cFrom"></td>
			  
			  <td style="width: 10%; padding-right: 0px;">Company Name</td>
			  <td><input type="text"></td>
			   <td style="width: 11%;padding-right: 0px;">Sales Date</td>
			  <td><input type="text"></td>
			</tr>
			
			<tr>
			  <td style="width: 13%; padding-right: 0px;">Customer</td>
			  <td><table class="cus-tab">
			  ...
			  <td style="width: 12%; padding-right: 0px;">Site</td>
			  <td><table>
			    <td style="padding: 0px;"><input type="text"></td>
		  ...
		  <div class="sales-entry-table">
		    <table class="sales-table" id="bottom-cash">
		      <tr>
			
			<td class="text-fiel">Company Name</td>
			...
			<td class="text-fiel">Report Name</td>
			<td><input type="text" class="ent-in"></td>
			...
			<td class="text-fiel" style="width: 51%;">Address</td>
			<td><input type="text" class="ent-in"></td>
	    ...
	    <div class="total-view">
		   <table>
		    ...
		    <!--<tr>
		      <td>
			<table style="width:100%;">
			<td style="width: 62%; text-align: center;">Discount</td>
...
window.onclick = function(event) {
 ...
 <div id="myModal3" class="modal3">
  ...
  <!-- Modal content -->
  <div class="modal-content3" style="width: 52%;">
