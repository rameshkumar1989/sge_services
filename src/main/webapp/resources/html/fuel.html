...
$("document").ready(function(){
      ...
      $('.addrow').click(function() 
     {
    	...
    	$(".transport_table").append('<tr id="remove_transport"><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td style="padding:0px; background: #fff;text-align: center;"><img src="images/cancel_tab.png" onclick="deleterow()" style="width:18px;"></td></tr>'); 
    ...
    function deleterow()
    {
     ...
     if($(".transport_table tr").length != 1)
    {
        $("#remove_transport").remove();
    }
    else
    {
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<tr>
			  ...
			  <td style="width: 57%;text-align: end;">Search By Vehicle No/Name</td>
		    ...
		    <div class="supplier-view" id="transport">
		      
		      <table style="width: 241%;" class="transport_table">
			...
			<th>SKM</th>
			<th>TKM</th>
			<th>Milegde Pet LTR</th>
			<th>Diesel</th>
			<th>Price Per LTR</th>
			<th>LTR</th>
			<th>Price PE</th>
			<th>Rs.</th>
			<th style="border:none;">PCS.</th>
			<th style="border:none;"></th>
			<!--<th style="width: 2%;">Delete</th> -->
                         </tr>
			 <tr id="remove_transport">
			  <!--<td><input type="text"></td>-->
			  <td><input type="text"></td>
			  <td><input type="text"></td>
			 <td><input type="text"></td>
...
$(document).on('keydown', '.inputss', function(e) {
  ...
  if (code == 13) {
    ...
    $('.inputss').eq(index).focus();
		    ...
		    <div class="whole-payment">
			 ...
			 <fieldset>
  <legend class="fuel_legend_own"><b>Fuel Master:</b></legend>
   <table class="sub-table1-fuel">
    <tr>
      <td class="text-sub-tra">Vehicle No</td>
      <td><input type="text" readonly></td>
       
       <td class="text-sub-tra">Vehicle Name</td>
      <td><input type="text" readonly></td>
    </tr>
    
    <tr>
      <td class="text-sub-tra">Driver Name</td>
      <td><input type="text"></td>
      
      <td class="text-sub-tra">Bill Date</td>
      <td><input type="text" class="cFrom"></td>
      
    </tr>
    
    <tr>
      <td class="text-sub-tra">Bill No</td>
      <td><input type="text"></td>
      
      <td class="text-sub-tra">EKM</td>
      <td><input type="text"></td>
    </tr>
    
    <tr>
      <td class="text-sub-tra">SKM</td>
      <td><input type="text"></td>
       <td class="text-sub-tra">TKM</td>
      <td><input type="text"></td>
    </tr>
    <tr>
      <td class="text-sub-tra">Miledge Per LTR</td>
      <td><input type="text"></td>
       
       <td class="text-sub-tra">Diesel</td>
      <td><input type="text"></td>
    </tr>
    <tr>
      <td class="text-sub-tra">Price Per LTR</td>
      <td><input type="text"></td>
       <td class="text-sub-tra">LTR</td>
      <td><input type="text"></td>
    </tr>
    <tr>
      <td class="text-sub-tra">Price PE</td>
      <td><input type="text"></td>
       <td class="text-sub-tra">Rs.</td>
      <td><input type="text"></td>
    </tr>
   <tr>
      <td class="text-sub-tra">Pcs.</td>
      <td><input type="text"></td>
  ...
  <!-- <table class="sub-table2">
    <tr>
       <td class="text-sub2">Transport Name</td>
      <td><input type="text"></td>
    </tr>
    
    <tr>
       <td class="text-sub2">Vehicle No</td>
      <td><input type="text"></td>
    </tr>
    
    <tr>
       <td class="text-sub2">City</td>
      <td><input type="text"></td>
    </tr>
    <tr>
       <td class="text-sub2">Pin Code</td>
      <td><input type="text"></td>
    </tr>
    <tr>
      <td class="text-sub2">CFT</td>
      <td><table>
      <tr>
      <td style="width: 14%;"><input type="text" style="width: 100%;"></td>
      <td class="text-sub2" id="supp-tet">Contact No</td>
   ...
   <tr>
      ...
      <td><table>
      <tr>
      <td style="width: 14%;"><input type="text" style="width: 30%;"></td>
