              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="top-field" id="pe_tabss">
			<tr>
			  ...
			  <td><input type="text" style="width: 78%;" id="cTo"></td>
		       ...
		       <table class="top-field" id="second-pe1" style="margin-left: -40px;">
			<tbody><tr>
			  <td style="width: 18%;">P.E Book No.</td>
			  <td>From</td>
			  <td style="width: 34%;">
			    <input type="text" style="width: 101%;"></td>
			    <td style="width: 7%; padding-left: 6px;"><input type="button" style="margin-top: 0px;" value="N" id="myBtn1" class="txt-inputs"></td>
			  
			  <td style="width: 11%;text-align: center;">To</td>
			  <td width:27%;=""><input type="text" style="width: 90%;margin-left: 7px;"> </td>
			  <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn2" style="margin-top: 0px;" class="txt-inputs"></td>
			</tr>
			
		      </tbody></table>
		        <table class="top-field" id="second-pe2">
			<tbody><tr>
			  <td style="width: 16%;">P.E Book No.</td>
			  <td>From</td>
			  <td style="width: 34%;">
			    <input type="text" style="width: 101%;"></td>
			    <td style="width: 7%; padding-left: 6px;"><input type="button" style="margin-top: 0px;" value="N" id="myBtn1" class="txt-inputs"></td>
...
window.onclick = function(event) {
 ...
 <div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="vehicle-search">Book Search</div>
    <div class="in-model">
    
    <span class="close" style="opacity:7;">&times;</span>
    <table style="width: 96%;margin-top: 14px;">
      <tr>
	<td>Search By Book</td>
	<td><input type="text"></td>
      </tr>
      </table>
      <div class="model-grid">
