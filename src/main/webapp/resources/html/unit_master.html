...
$("document").ready(function(){
      ...
      $('.addrow').click(function() 
     {
    	...
    	$(".unit_table").append('<tr id="remove_unit"><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td><input type="text"></td><td style="padding:0px; background: #fff;text-align: center;"><img src="images/cancel_tab.png" onclick="deleterow()" style="width:18px;"></td></tr>'); 
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<tr>
			  ...
			  <td style="width: 58%;text-align: end;">Search By Unit Code/Name</td>
		    ...
		    <div class="supplier-view-item" id="unit">
			...
			<tr>
			 <!-- <th style="width:1%;"><img src="images/Plus_Sign.png" class="addrow" style="width:21px;"></th>-->
			  ...
			  <th>Unit Code</th>
			<th style="border:none;">Unit Description</th>
  ...
  if (code == 13) {
    ...
    $('.inputss').eq(index).focus();
		    ...
		    <div class="whole-payment">
		     ...
		     <div class="supplier-list" style="width: 86%; margin-left: 106px; margin-top: 25px;">
		      
		       
			 <fieldset>
  <legend class="unit-legend"><b>Unit Master</b></legend>
   <table class="sub-table1" style="width: 100%;">
    <tr>
      <td class="text-sub1">Unit Code</td>
      <td><input type="text"></td>
       <td class="text-sub1">Unit Description</td>
      <td><input type="text"></td>
    </tr>
