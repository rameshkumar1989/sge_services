          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>PURCHASE ENTRY <span class="levels">LEVEL 2</span></h2>
			...
			<tr>
			  ...
			  <td><input type="text"></td>-->
			  <td style="width: 4%;"><a href="#"><input type="button" value="N" id="myBtn" style="line-height: 0px;"></a></td> 
			  
			  <!--<td style="width: 10%;padding-right: 0px;">Book No</td>
			  <td ><input type="text"></td>-->
			  
			  <td style="width: 12%;padding-right: 0px;">Purchase Date</td>
			  <td><input type="text" class="cFrom"></td>
			  
			  <td style="width: 11%;padding-right: 0px;">Vendor Name</td>
			  <td><input type="text"></td>
			</tr>
			<!--<tr>
...
$(document).on('keydown', '.inputss', function(e) {
  ...
  if (code == 13) {
    ...
    $('.inputss').eq(index).focus();
			...
			<tr>
			  <td><button type="button" class="button-entry"><img src="images/edit.png"></br>Row Edit</button></td>
			  
			</tr>
			<tr>
			  <td><button type="button" class="button-entry"><img src="images/edit2.png"></br>Full Edit</button></td>
			  
			</tr>
			<tr>
			  <td><button type="button" class="button-entry"><img src="images/exit.png"></br>Exit</button></td>
