          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
               <!-- <h3>VEHICLE MEASUREMENTS REPORT</h3>-->
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Vehicle Measurement Report</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table class="top-field" id="vehicle_report">
			<tr>
			...
			<tr>
			 ...
			 <td style="width: 7%; padding-left: 6px;"><input type="button" value="N" id="myBtn6" class="txt-inputs"></td>
		        ...
		        <table class="top-field" id="extra-fil">
			<tr>
			  <td>Sales Qty</td>
			  <td>From Date</td>
			  <td><input type="text" style="width: 100%;" id="cTo1"></td>
			  <td>To Date</td>
			  <td><input type="text" style="width: 100%;" id="cTo2"></td>
			</tr>
...
window.onclick = function(event) {
 ...
 <div id="myModal" class="modal">
  ...
  <!-- Modal content -->
  <div class="modal-content" style="width: 52%;">
