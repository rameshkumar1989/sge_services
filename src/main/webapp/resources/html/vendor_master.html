...
<table class="tab-ventor">
  <tr>
    <td class="tab-td">Choose Vendor</option></td>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="supplier-list">
			 ...
			 <fieldset>
  <legend class="supplier_legend"><b>Registered Vendor</b></legend>
...
<td class="text-sub">Vendor Company Name</td>
   ...
   <div class="open_blnc-sup">
			<fieldset>
  <legend class="legend" id="supplier_legend2">Bank Details-Add Multiple Account 1</legend>
  <table>
     <tr>
   ...
   <div class="open_blnc-sup">
			<fieldset>
  <legend class="legend" id="supplier_legend21">Opening Balance</legend>
  <table  class="vendor-tabs">
    <tr>
      <td style="width:1%;">Date</td>
      <td style="width: 4%;"><input type="text" id="cTo1"></td>
    ...
    <tr>
      ...
      <td><input type="text"></td>
		    ...
		    <div class="right-whole-design-sales" style="margin-left: 31%;">
		      <table>
			<tr>
			  <td><button type="button" class="button-sales"><img src="images/add.png" class="addbank"></br>Add Row</button></td>
