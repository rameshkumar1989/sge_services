...
<div class="form-name">SRI GANAPATHY ENTERPRISES</div>
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="top-field" id="sales-tabs">
			<tr>
			...
			<tr>
			  <td class="resize">MRO No </td>
			  <td class="resize"><input type="text"></td>
			  <!--<td><input type="text" style="display:none;width: 21%; margin-left:10px;"></td>-->
			</tr>
			<tr>
			  <td class="resize">LRY DC No </td>
			  <td class="resize"><input type="text"></td>
			  <!--<td><input type="text" style="display:none;width: 21%; margin-left:10px;"></td>-->
			</tr>
			</table>
		      
		       <table class="top-field" id="top-sales">
			<tr>
